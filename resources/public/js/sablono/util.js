...
var x__17031__auto__ = (((x == null))?null:x);
var m__17032__auto__ = (sablono.util.to_str[goog.typeOf(x__17031__auto__)]);
if(!((m__17032__auto__ == null))){
return m__17032__auto__.call(null,x);
} else {
var m__17032__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__17032__auto____$1 == null))){
return m__17032__auto____$1.call(null,x);
} else {
...
var x__17031__auto__ = (((x == null))?null:x);
var m__17032__auto__ = (sablono.util.to_uri[goog.typeOf(x__17031__auto__)]);
if(!((m__17032__auto__ == null))){
return m__17032__auto__.call(null,x);
} else {
var m__17032__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__17032__auto____$1 == null))){
return m__17032__auto____$1.call(null,x);
} else {
...
var len__17434__auto___24444 = arguments.length;
var i__17435__auto___24445 = (0);
while(true){
if((i__17435__auto___24445 < len__17434__auto___24444)){
args__17441__auto__.push((arguments[i__17435__auto___24445]));

var G__24446 = (i__17435__auto___24445 + (1));
i__17435__auto___24445 = G__24446;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__17442__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq24443){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq24443));
});
/**
...
var vec__24448 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__24448,(0),null);
var words = cljs.core.nthnext.call(null,vec__24448,(1));
...
var G__24450 = clojure.set.rename_keys.call(null,m,kmap);
var G__24450__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__24450,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__24450);
return G__24450__$1;
} else {
return m;
}
...
var args__17441__auto__ = [];
var len__17434__auto___24453 = arguments.length;
var i__17435__auto___24454 = (0);
while(true){
if((i__17435__auto___24454 < len__17434__auto___24453)){
args__17441__auto__.push((arguments[i__17435__auto___24454]));

var G__24455 = (i__17435__auto___24454 + (1));
i__17435__auto___24454 = G__24455;
continue;
} else {
}
break;
...
var argseq__17442__auto__ = ((((0) < args__17441__auto__.length))?(new cljs.core.IndexedSeq(args__17441__auto__.slice((0)),(0))):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__17442__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__24451_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__24451_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__24451_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__24451_SHARP_)){
return p1__24451_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__24451_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq24452){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq24452));
});
/**
...
var vec__24459 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__24459,(0),null);
var names = cljs.core.nth.call(null,vec__24459,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__24459,tag_name,names){
return (function (p1__24456_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__24456_SHARP_));
});})(matches,vec__24459,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__24459,tag_name,names){
return (function (p1__24457_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__24457_SHARP_));
});})(matches,vec__24459,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__24460){
var vec__24463 = p__24460;
var tag = cljs.core.nth.call(null,vec__24463,(0),null);
var content = cljs.core.nthnext.call(null,vec__24463,(1));
...
var vec__24464 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__24464,(0),null);
var id = cljs.core.nth.call(null,vec__24464,(1),null);
var class$ = cljs.core.nth.call(null,vec__24464,(2),null);
